...
enrichment analysis) of peaks. This also includes peak enrichment around TSS. 
...
EpiCompare(peakfiles = list(`r names(peaklist_tidy)`),
           ...
           n_threshold = `r params$n_threshold`,
...
pr_out <- NULL
if(params$precision_recall_plot &&
   (!is.null(reference))){
    #### Create save path ####
...
The frequency of peaks upstream (-3000bp) and downstream (+3000bp) of 
