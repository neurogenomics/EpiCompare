...
genomic region where the peak is located. The [transcript-related features](http://bioconductor.org/packages/release/data/annotation/html/TxDb.Hsapiens.UCSC.hg19.knownGene.html) are taken from the annotations of human genome hg19 provided by Bioconductor.
