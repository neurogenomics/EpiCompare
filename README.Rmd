...
author: "<h5><i>Authors</i>: Sera Choi, Brian Schilder, Alan Murphy, and Nathan Skene</h5>"
...
* `reference` : Reference peak file is used in `stat_plot` and `chromHMM_plot`. File must be in GRanges object, listed and named using `list("reference_name" = GRanges_obect)`
